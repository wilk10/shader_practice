...
layout(set = 2, binding = 0) uniform SpawnVfx_color_a {
    vec4 color_a;
};
layout(set = 2, binding = 1) uniform SpawnVfx_color_b {
    vec4 color_b;
};
layout(set = 2, binding = 2) uniform SpawnVfx_start_lerp {
    float start_lerp;
};
layout(set = 2, binding = 3) uniform SpawnVfx_end_lerp {
    float end_lerp;
};
